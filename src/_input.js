...
util.inherits(_input, Writable);

_input.prototype.read = function (samples) {
...
_input.prototype.readMono = function (samples) {
...
_input.prototype.readStereo = function (samples) {
...
_input.prototype.setVolume = function(volume) {
  this.volume = Math.max(Math.min(volume, 100), 0);
};

_input.prototype.getVolume = function() {
  return this.volume;
}
